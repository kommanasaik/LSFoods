...
@IonicPage()
@Component({
  selector: 'page-purchasereport',
  templateUrl: 'purchasereport.html',
})
export class PurchasereportPage {
  ...
  */
    constructor(
      ...
      this.headerTitle="Purchase Reports";
  ...
  */
  ...
  submitDate() {
      ...
      this.utils.getpurchasereport(this.fromdate,this.todate).subscribe((Response) => {
